...
COMMON_SUPPLIES=( .prettierrc .eslintrc.cjs .stylelintrc.js .stylelintignore )

PLATFORM_SUPPLIES=( .prettierignore .eslintignore postcss.config.js phpstan.neon pint.json psalm.xml )
